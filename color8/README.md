...
<p align="center">
  <img src="../gallery/presets.png" width="640" alt="Built-in palette presets, including one parsed from gradient bytes"><br>
  <code>cargo run --example presets</code> — <a href="src/presets.rs"><code>HEAT_COLORS</code></a>/<code>OCEAN_COLORS</code>/<code>PARTY_COLORS</code>, plus <a href="src/gradient_palette.rs"><code>rainbow_gradient_palette16</code></a> parsed from gradient-palette bytes at runtime.
</p>
...
| Gradient-palette format (`crgb_palette16/32/256_from_gradient`) | ✅ | vs. C, incl. slot-compaction edge cases |
| Presets (`CloudColors`, `HeatColors`, `RainbowColors`, `Rainbow_gp`, …) | ✅ | transcribed from `colorpalettes.cpp` |
| `blur1d` | ⬜ | — |
